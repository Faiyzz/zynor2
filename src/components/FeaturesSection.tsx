...
export default function FeaturesSection() {
  // chunk services into pages of 6
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 md:px-10 flex flex-col gap-10 md:gap-12 w-full">
        {/* Heading + Arrows stacked, centered */}
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="
                ...
                ring-1 ring-black/10 shadow-[0_12px_24px_rgba(0,0,0,0.08)]
        ...
        <div className="relative overflow-x-hidden pt-16 ">
          ...
          >
            {pages.map((page, idx) => (
              ...
              >
                {/* Page grid: desktop = 3 columns (2 rows), mobile stacks naturally */}
                <div
                  className="
                    grid
                    grid-cols-1
                ...
                >
                  {page.map((item, i) => (
                    ...
                    >
                      ...
                      {/* Desc (equal height so buttons align across row) */}
